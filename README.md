...
<p align="center"><img src="./docs/assets/launch-layout-report.png" alt="오토한글(auto-hwp) 편집 화면의 레이아웃 문제 제보 버튼" width="900"></p>

개발자가 아니어도 괜찮습니다. **문서 하나를 열어 보고 차이가 나는 지점을 알려 주는 순간 컨트리뷰터입니다.**
오토한글(auto-hwp)의 미션은 AI가 한글을 이해하고, 수정하고, 마침내 정복할 수 있는 미래를 만드는 것입니다.
지금은 서로 다른 문서의 긴 꼬리를 집단지성으로 함께 찾아야 하는 베타 단계입니다.
...
| 최근 npm 릴리스 | `@auto-hwp/engine` 0.0.5 (2026-08) | `@rhwp/core` 0.8.2 (2026-07) | `hwp.js` 0.0.3 (2020-10) |
