...
- [x] 소유자가 개인정보 문구와 실제 운영을 대조해 승인함
- 승인자/시각: 프로젝트 소유자 · 2026-08-12 KST · Codex 대화에서 승인
- 필요한 수정: AI 문맥은 전송되지만 오토한글(auto-hwp)은 원본 문서·전송된 문맥·AI 응답을 자체
  데이터베이스나 스토리지에 저장·보유하지 않는다는 문구를 명시. 남용 방지용 IP·날짜별 횟수 키는
  문서 콘텐츠와 구분해 약 25시간 보유 예외로 고지.
...
- [x] 소유자가 한국어/영어 README와 콘텐츠 브리프의 핵심 주장·금지 주장을 승인함
- 승인자/시각: 프로젝트 소유자 · 2026-08-12 KST · Codex 대화에서 승인
- 필요한 수정: 없음. 첫 Threads 초안·시각 자산과 브라우저 레이아웃 제보 퍼널 구현도 함께 승인함.
