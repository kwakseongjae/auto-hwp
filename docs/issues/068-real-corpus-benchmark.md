...
- 2026-07-30 갱신: 잔여 "시각 파리티 축"의 **v1 = 수치 공개로 대체** — 공개 페이지 `/bench`
  (`989d03d`, 정본 docs/BENCHMARK.md)가 게이트 수치+재현 커맨드를 게재. 원본↔렌더 나란히 이미지
  축은 **미착수 유지**(제3자 문서 공개 재배포 회피 — 2026-07-29 사용자 결정. 재개하려면 자체 제작
  또는 KOGL 확인 문서로만).
