...
| [074](074-hwpx-page-undercount.md) | HWPX 입력 쪽수 20~25% 과소 계산 | **open** | P1 (충실도 남은 최대 갭) | 오라클 실측: benchmark1 .hwp 18==18 ✅ / 같은 문서 .hwpx 25 vs 우리 20 ❌, 한컴 저작 hwpx 4 vs 3. IR 은 파리티 오라클이 rhwp 와 일치 확인 → **조판 축**. 표 앵커 수정(59f784e)으로 가려져 있던 것이 드러남 |
