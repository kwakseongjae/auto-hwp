...
| [047](047-precise-width-shade-sdk.md) | 열너비 mm 정밀+균등 분배+편집 중 셀음영 | open | R11-P1 | 배치 B; 047=표 오버레이 영역 소유 |
| [048](048-ribbon-sdk.md) | 상단 서식 리본 — 선택+편집(라이브) 이중 동작 | open | R11-P1 | 배치 B; 048=헤더/라이브스타일 영역 소유 |
