...
| [062](062-rhwp-renderer-promotion.md) | rhwp 렌더러 계층 승격 | **진행 중** (062-1·062-2 done) | R14 배치 | 062-1 배포용복호(c716e8f, 056해소)·062-2 옛한글(6b6d22d) 병합·검증(e2e 39/39). 다음 062-3 금칙. 잔여: 대각선·수식·폰트메트릭 |
