...
| [062](062-rhwp-renderer-promotion.md) | rhwp 렌더러 계층 승격 | **quick win 완료** (062-1/2/3 done) | R14 배치 | 062-1 배포용복호(056해소)·062-2 옛한글·062-3 금칙(c556114) 병합·검증(e2e 39/39, 게이트 불변). 잔여: 대각선·수식·폰트메트릭·차트 |
