...
## 지금 (현재 위치)
- 로드맵 기준: **R12 + R13 완료, R14 전체 완료** — R12(051~057), R13(058·059·060),
  R14 062 quick win(062-1 배포용복호=056해소·062-2 옛한글·062-3 금칙) + **062 잔여 배치(062-4 대각선 X자·
  062-5 수식렌더 v1·062-7 차트 v1, 15fc718)** + 063 웹 이식 패키징. 전부 병합·검증(게이트 8==8·18==18, e2e 39/39).
