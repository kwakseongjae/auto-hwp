...
- 기준 커밋: `5693ecb`(웹 QA 2차 배치) — **R12~R14 + 실물QA 065·066 + 웹QA피드백 #1~#4 완료**. GitHub: https://github.com/kwakseongjae/tf-hwp (private)
- 갱신: 2026-07-14 · Claude — 웹 QA 2차 피드백 4건 배치: #1 스테일dist(라벨덮어쓰기)·#2 deselect·#4 Figma표선택·#3 인라인편집.
  전 검증 그린(게이트 8==8/18==18, vitest 162/301/20/41, e2e 21). 미푸시분 있으면 이 배치. 이전: 065(79ecd1a 푸시)·066(dab3e87).
