...
- 기준 커밋: `80d2607`(웹 QA 4차 배치 = 차트) — **R12~R14 + 실물QA 065·066 + 웹QA 2차(#1~#4)·3차(①②③)·4차(8/8: 호버·표생성·중첩표Tier1+2·썸네일·멀티모달·에이전틱AI·차트) 완료**. GitHub: https://github.com/kwakseongjae/tf-hwp (private)
- 갱신: 2026-07-14 · Claude — 웹 QA 3차 배치: ①AI채우기 검정색(32f521b)·②다중페이지 드래그(c6e5319)·③챗카드revert+웹검색인용(4aa1083).
  전 검증 그린(게이트 8==8/18==18, vitest 23/163/305/44, e2e 챗/smoke 11). 미푸시분 있으면 이 배치. 2차=ace7657, 065=79ecd1a, 066=dab3e87.
...
**남은 것: C(표 행높이/cellSz/borderFill — 잔여 페이지수 갭의 주원인)·D(이미지 hp:pic+bin_data)** = 사용자 결정 대기. rhwp가 이미 HWPX 완전파싱 → 하이브리드가 폴백.
