...
- 기준 커밋: `941ea13`(오픈소스화 준비 — LICENSE·README·정적 데모·랜딩 히어로) — **R12~R14 + 실물QA 065·066 + 웹QA 2~6차 + HWPX 시각 파리티 + 레이아웃 정리 토글 완료**. GitHub: https://github.com/kwakseongjae/tf-hwp (private)
