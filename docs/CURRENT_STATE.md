...
- 기준 커밋: `4aa1083`(웹 QA 3차 배치) — **R12~R14 + 실물QA 065·066 + 웹QA피드백 2차(#1~#4)·3차(①②③) 완료**. GitHub: https://github.com/kwakseongjae/tf-hwp (private)
