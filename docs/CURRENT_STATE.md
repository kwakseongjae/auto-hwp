...
- 기준 커밋: `60349e3`(웹 QA 4차 배치 = 차트) — **R12~R14 + 실물QA 065·066 + 웹QA 2차(#1~#4)·3차(①②③)·4차(8/8: 호버·표생성·중첩표Tier1+2·썸네일·멀티모달·에이전틱AI·차트) 완료**. GitHub: https://github.com/kwakseongjae/tf-hwp (private)
