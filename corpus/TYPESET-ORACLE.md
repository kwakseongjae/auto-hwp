...
| 줄격차 | 15 |
| 쪽격차 | 10 |
| 본문 줄정확 평균 (채점 가능·본문 오라클만) | 97.6% |
| 셀 줄정확 평균 (채점 가능·셀 오라클만) | 97.2% |

## 요소별 점수 (채점 가능 문서만 — 채점 불가를 0으로 넣지 않음)

| 축 | 한국어 | 태깅 | 채점가능 | 채점불가 | 쪽수일치율% | 본문 줄정확% | 셀 줄정확% |
|---|---|---:|---:|---:|---:|---:|---:|
| `header_footer` | 머리말/꼬리말 | 5 | 5 | 0 | 60 | 93.9 | 97.6 |
| `form_control` | 폼 컨트롤 | 4 | 4 | 0 | 100 | 100 | — |
| `mixed_orientation` | 가로세로 혼합 | 0 | 0 | 0 | — | — | — |
| `nested_table` | 중첩 표 | 10 | 10 | 0 | 60 | 97.5 | 98.5 |
| `multipage_table` | 다쪽 표 | 16 | 15 | 1 | 66.7 | 97.7 | 95.7 |
| `footnote` | 각주 | 1 | 1 | 0 | 0 | 90 | 100 |
| `multicolumn` | 다단 | 2 | 2 | 0 | 50 | 91.7 | — |
| `chart` | 차트 | 1 | 1 | 0 | 100 | 99 | 100 |
| `equation` | 수식 | 3 | 2 | 1 | 50 | 100 | — |
| `shape_ole` | 도형/OLE | 33 | 33 | 0 | 87.9 | 98.6 | 97.7 |
...
| 3 | `header_footer` (머리말/꼬리말) | 5 | 60 | 93.9 | 97.6 |
...
| `benchmarks/benchmark1.hwp` | benchmark | 일치 | 18 | 18 | 99.2 | 98.9 | nested_table, multipage_table |
| `benchmarks/benchmark1.hwpx` | benchmark | 쪽격차 | 30 | 25 | 88.6 | — | nested_table, multipage_table |
| `benchmarks/benchmark2.hwp` | benchmark | 일치 | 24 | 24 | 99.7 | 98.4 | nested_table, multipage_table |
| `corpus/hwp/복학원서.hwp` | corpus-hwp | 줄격차 | 1 | 1 | 94.1 | 100 | shape_ole |
...
| `corpus/hwp/hwp-multi-001.hwp` | corpus-hwp | 줄격차 | 9 | 9 | 98.4 | 85 | multipage_table, shape_ole |
| `corpus/hwp/issue_265.hwp` | corpus-hwp | 쪽격차 | 17 | 16 | 93.3 | 96.9 | header_footer |
| `corpus/hwp/issue-505-equations.hwp` | corpus-hwp | 일치 | 4 | 4 | 100 | — | equation |
| `corpus/hwp/k-water-rfp.hwp` | corpus-hwp | 줄격차 | 27 | 27 | 94.4 | 96.5 | header_footer, nested_table, multipage_table, shape_ole |
| `corpus/hwp/math-001.hwp` | corpus-hwp | 쪽격차 | 2 | 1 | 100 | — | equation |
| `corpus/hwp/shape-001.hwp` | corpus-hwp | 일치 | 1 | 1 | 100 | — | shape_ole |
| `corpus/hwp/tac-img-02.hwp` | corpus-hwp | 쪽격차 | 63 | 66 | 98.2 | 98.8 | nested_table, multipage_table, shape_ole |
...
| `corpus/hwpxlib_corpus/error/20230728/test.hwpx` | hwpxlib | 줄격차 | 39 | 39 | 97.8 | 99.4 | nested_table, multipage_table, shape_ole |
| `corpus/hwpxlib_corpus/error/20230809/test.hwpx` | hwpxlib | 줄격차 | 1 | 1 | 83.3 | — | header_footer, multicolumn, shape_ole |
| `corpus/hwpxlib_corpus/error/20230818/test.hwpx` | hwpxlib | 일치 | 5 | 5 | 100 | 95.3 | nested_table, multipage_table, shape_ole |
...
| `corpus/hwpxlib_corpus/error/20240626/no_manifest.hwpx` | hwpxlib | 줄격차 | 4 | 4 | 98.1 | 83.3 | — |
...
| `corpus/hwpxlib_corpus/error/20250808/2015년_12월_재난안전종합상황_분석_및_전망.hwpx` | hwpxlib | 쪽격차 | 77 | 76 | 98.6 | 99.5 | header_footer, nested_table, shape_ole |
| `corpus/hwpxlib_corpus/error/20251107/test_re.hwpx` | hwpxlib | 일치 | 15 | 15 | 99.1 | 87.6 | multipage_table |
| `corpus/hwpxlib_corpus/error/20251107/test.hwpx` | hwpxlib | 일치 | 15 | 15 | 99.1 | 87.6 | multipage_table |
...
| `corpus/private/bench-public/files/kogl__붙임_개방지원_사업_신청서.hwp` | gov | 쪽격차 | 12 | 11 | 100 | 99.3 | nested_table, multipage_table |
| `corpus/private/bench-public/files/kogl__서식1_저작재산권_양도_계약서.hwp` | gov | 줄격차 | 4 | 4 | 90.4 | 96.4 | — |
...
| `corpus/private/bench-public/files/korea-kr-mcst__0212_개선이_필요한_공공언어_30선_발표.hwpx` | gov | 줄격차 | 5 | 5 | 94.3 | 100 | multipage_table, shape_ole |
| `corpus/private/bench-public/files/korea-kr-mcst__0326_광화문_현판_토론회_개최.hwpx` | gov | 줄격차 | 3 | 3 | 92.9 | 100 | — |
| `corpus/private/bench-public/files/korea-kr-mcst__0411_문체부_2026년_1회_추경_확정.hwpx` | gov | 줄격차 | 4 | 4 | 97.6 | 97.7 | — |
| `corpus/private/bench-public/files/korea-kr-mcst__0413_사회문화시설_활용_인문_프로그램_공모.hwpx` | gov | 줄격차 | 5 | 5 | 92.7 | 99 | — |
| `corpus/private/bench-public/files/korea-kr-moel__260331_보도참고_2026년_제1차_추경예산안_주요내용.hwpx` | gov | 쪽격차 | 7 | 6 | 96.2 | 95.5 | multipage_table, shape_ole |
| `corpus/private/bench-public/files/korea-kr-mpva__260413_보도자료_2026년_국외_보훈사적지_답사_참가자_모집.hwpx` | gov | 쪽격차 | 5 | 4 | 100 | 98 | multipage_table, shape_ole |
| `corpus/private/bench-public/files/mohw__보도참고_도수치료_관리급여_전환_3종_고시개정안_행정예고.hwpx` | gov | 줄격차 | 4 | 4 | 96.1 | 98.1 | — |
