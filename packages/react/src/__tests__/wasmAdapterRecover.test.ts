    ...
    applyIntent(intent: unknown) {
      ...
      if (s.includes('"ProposeIntents"')) return {
        ...
        risks: [], warnings: [], verification: {
          ...
          affected_pages: [0], unaffected_pages_checked: [], page_artifacts: [], pdf: null, structural_failures: [], advisories: [], commit_allowed: true, submission_ready: true,
        },
      };
