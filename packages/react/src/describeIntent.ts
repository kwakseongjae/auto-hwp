...
// Per-op-kind label + glyph for the proposal preview CARD header (010식). Mirrors the desktop app's
// OP_META (Chat.tsx). Unknown kinds fall back to a generic "편집" card.
