...
/// a host can drop it into any toolbar without HwpWorkspace. Copy comes from the injectable catalog
/// (issue 077 — `messages.table`, Korean by default). The picker grid itself
...
export function TableInsertButton({ maxRows = 8, maxCols = 8, disabled, onPick }: TableInsertButtonProps) {
  ...
  return (
    <div className="hw-tableins">
      ...
      {open && (
        <div className="hw-tableins-pop" role="dialog" aria-label={msg.table.sizePickerLabel} data-testid="hw-table-picker">
